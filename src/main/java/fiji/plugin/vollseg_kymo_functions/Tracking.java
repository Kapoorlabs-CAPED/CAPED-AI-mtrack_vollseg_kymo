 ...
 * #L%
 */
package fiji.plugin.vollseg_kymo_functions;
...
public class Tracking
{
	...
	public static XYSeries drawFunction( final fiji.plugin.vollseg_kymo.interpolation.Polynomial polynomial, final double from, final double to, final double step, final String name )
	{
		XYSeries series = new XYSeries( name );
	...
	public static XYSeries drawexpFunction( final fiji.plugin.vollseg_kymo.interpolation.Polynomial polynomial, final double from, final double to, final double step, final String name )
	{
		XYSeries series = new XYSeries( name );

 ...
 * #L%
 */
package fiji.plugin.vollseg_kymo.features;
...
import fiji.plugin.vollseg_kymo.SelectionModel;
import fiji.plugin.vollseg_kymo.features.ModelDataset.DataItem;
...
public abstract class ModelDataset extends AbstractDataset implements XYDataset, Iterable< DataItem >
{
			...
			final List< String > yFeatures )
	{
		...
		this.stroke = new BasicStroke( ( float ) 2, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND );
		this.selectionStroke = new BasicStroke( ( float ) 2, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND );

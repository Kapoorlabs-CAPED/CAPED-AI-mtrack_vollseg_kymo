...
public class MaxDistListener implements AdjustmentListener {
	...
	public MaxDistListener(final Load_ransac_fits parent, final Label label, final String string, final float min, float max,
	...
	public void adjustmentValueChanged(AdjustmentEvent e) {
		...
		parent.maxDist = (int) Math.round(Slicer.computeValueFromScrollbarPosition(e.getValue(), min, max, scrollbarSize));

	
		deltaScrollbar
				.setValue(Slicer.computeScrollbarPositionFromValue(parent.maxDist, min, max, scrollbarSize));

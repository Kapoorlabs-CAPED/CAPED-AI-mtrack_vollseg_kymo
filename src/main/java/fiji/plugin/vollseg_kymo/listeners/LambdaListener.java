...
public class LambdaListener implements AdjustmentListener
{
	...
	public LambdaListener( final Load_ransac_fits parent, final Label label, final Scrollbar bar )
	{
		this.parent = parent;
		this.label = label;
	...
	{
		parent.lambda = Load_ransac_fits.computeValueFromScrollbarPosition(
				event.getValue(),

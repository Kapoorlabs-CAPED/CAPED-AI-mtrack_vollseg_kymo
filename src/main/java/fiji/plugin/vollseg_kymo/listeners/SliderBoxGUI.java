...
public class SliderBoxGUI {
	...
	fiji.plugin.vollseg_kymo.layoutManager.Setlayout.LayoutSetter(combosliderbox);
	
	

	combosliderbox.add(valueText, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
			GridBagConstraints.HORIZONTAL, fiji.plugin.vollseg_kymo.layoutManager.Setlayout.insets, 0, 0));

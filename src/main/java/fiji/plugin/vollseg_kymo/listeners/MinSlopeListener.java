...
public class MinSlopeListener implements AdjustmentListener {
	...
	public MinSlopeListener(final Load_ransac_fits parent, final Label label, final String string, final float min, float max,
	...
	public void adjustmentValueChanged(AdjustmentEvent e) {
		...
		parent.minSlope = Slicer.computeValueFromScrollbarPosition(e.getValue(), min, max, scrollbarSize);

	
		deltaScrollbar
				.setValue(Slicer.computeScrollbarPositionFromValue(parent.minSlope, min, max, scrollbarSize));

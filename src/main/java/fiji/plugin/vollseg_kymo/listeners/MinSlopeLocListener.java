...
public class MinSlopeLocListener implements TextListener {
	...
	public MinSlopeLocListener(final Load_ransac_fits parent, final boolean pressed) {
	...
	public void textValueChanged(TextEvent e) {
		...
		parent.minSlopeSB.setValue(Slicer.computeScrollbarPositionFromValue((float)parent.minSlope,

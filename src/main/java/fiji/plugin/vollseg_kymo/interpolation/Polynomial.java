 ...
 * #L%
 */
package fiji.plugin.vollseg_kymo.interpolation;
...
public class Polynomial extends AbstractFunction<Polynomial> {
	...
	public double distanceTo(final Point point) {
		...
		if (degree == 2){
			...
			double returndistA = Boundingboxes.Distance(new double[] { x1, y1 }, new double[] { xc1, yc1 });
			
			double returndistB = Boundingboxes.Distance(new double[] { x1, y1 }, new double[] { xc2, yc2 });
			
			double returndistC = Boundingboxes.Distance(new double[] { x1, y1 }, new double[] { xc3, yc3 });
		...
		double returndist = Boundingboxes.Distance(new double[] { x1, y1 }, new double[] { xc, polyfunc });
		return returndist;
		}
	}
